...
__all__ = [
    'DISPID_SpeechAudioFormat', 'DISPID_SPPId', 'SPLO_DYNAMIC',
    'SpeechInterference', 'SDKLDefaultLocation', 'SPWT_DISPLAY',
    'DISPID_SRRDiscardResultInfo', 'eLEXTYPE_PRIVATE13',
    'SVF_Emphasis', 'SREBookmark', 'SGRSTTEpsilon',
    'DISPID_SGRSTPropertyValue', 'DISPID_SFSOpen',
    'SPSTREAMFORMATTYPE', 'SpInProcRecoContext',
    'DISPID_SVEEnginePrivate', 'DISPID_SPPName',
    'ISpeechRecoResultDispatch', 'DISPID_SVSVisemeId', 'SPCS_ENABLED',
    'eLEXTYPE_PRIVATE8', 'SPFM_OPEN_READWRITE', 'STCAll',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SGRSTType',
    'DISPID_SRCEEnginePrivate', 'SAFT16kHz16BitMono', 'SPPS_Unknown',
    'DISPID_SVAlertBoundary', 'SPFM_OPEN_READONLY',
    'SDA_One_Trailing_Space', 'DISPID_SLRemovePronunciation',
    'SpeechTokenValueCLSID', 'DISPID_SRCreateRecoContext',
    'DISPID_SPPConfidence', 'SPEI_SR_PRIVATE',
    'Speech_StreamPos_Asap', 'DISPID_SRSSupportedLanguages',
    'DISPID_SRGCommit', 'SVP_11', 'SPDKL_CurrentConfig',
    'SpMMAudioIn', 'STSF_FlagCreate', 'SpeechLoadOption',
    'SPSERIALIZEDPHRASE', 'DISPID_SASetState', 'eLEXTYPE_RESERVED8',
    'SPPHRASEELEMENT', 'ISpNotifySource', 'DISPID_SPPParent',
    'SPEI_FALSE_RECOGNITION', 'SAFT16kHz16BitStereo', 'SPRECOSTATE',
    'SPSFunction', 'SSTTDictation', 'DISPID_SOTRemoveStorageFileName',
    'SPWF_SRENGINE', 'SPCT_SUB_COMMAND', 'SVEPhoneme',
    'SAFT8kHz16BitMono', 'SpeechCategoryAudioIn', 'SpeechRecoEvents',
    'DISPID_SAFGuid', 'ISpeechGrammarRuleState',
    'SpeechPropertyResourceUsage', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRCEFalseRecognition', 'DISPID_SLWPronunciations',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPSModifier',
    'DISPID_SRGCmdSetRuleState', 'SAFTADPCM_11kHzStereo',
    'DISPID_SRCERecognition', 'SpMemoryStream', 'ISpeechAudio',
    'DISPID_SpeechAudioStatus', 'SGDSActiveUserDelimited',
    'DISPID_SVDisplayUI', 'SP_VISEME_13', 'SSTTTextBuffer',
    'STSF_AppData', 'DISPID_SPIAudioSizeTime',
    'SpeechBookmarkOptions', 'DISPID_SpeechAudio',
    'ISpeechPhraseElements', 'SRESoundStart', 'SAFT11kHz8BitStereo',
    'SpSharedRecoContext', 'DISPID_SABIBufferSize',
    'SECFIgnoreKanaType', 'STCInprocServer', 'SASStop',
    'SDKLCurrentUser', 'DISPID_SPPsCount',
    'DISPID_SpeechGrammarRuleState', 'SPSHT_NotOverriden',
    'DISPID_SPCPhoneToId', 'eLEXTYPE_PRIVATE19', 'SP_VISEME_16',
    'SPPS_RESERVED1', 'SpeechTokenKeyFiles', 'SGDisplay',
    'eLEXTYPE_PRIVATE2', 'SPVPRI_ALERT', 'SPSHORTCUTPAIR',
    'SWPKnownWordPronounceable', 'SPEVENT', 'DISPID_SRRTLength',
    'SPAR_Medium', 'SAFT24kHz8BitMono', 'ISpeechAudioBufferInfo',
    'ISpSerializeState', 'DISPID_SASFreeBufferSpace', 'SVF_Stressed',
    ...
    'DISPID_SRIsUISupported', 'SVP_10', 'SpeechUserTraining',
    'SVP_12', 'DISPID_SRCPause', 'SRTEmulated',
    'SAFT44kHz16BitStereo', 'SPEI_RECOGNITION', 'SVPOver',
    'SPCT_SLEEP', 'eLEXTYPE_PRIVATE10', 'SSFMOpenForRead',
    'ISpeechRecoResult2', 'DISPID_SRGState', 'SP_VISEME_11',
    'SVEStartInputStream', 'DISPID_SGRSTsCount', 'SVEAllEvents',
    'SPRECOCONTEXTSTATUS', 'DISPID_SVEAudioLevel', 'SpeechVisemeType',
    'SFTSREngine', 'SPEI_TTS_AUDIO_LEVEL', 'STSF_LocalAppData',
    'SPEI_SENTENCE_BOUNDARY', 'SRAImport', 'SVSFParseAutodetect',
    'SVP_14', '_ISpeechVoiceEvents', 'DISPID_SVRate',
    'SDTReplacement', 'DISPID_SLWs_NewEnum', 'DISPID_SLPsItem',
    'SPWORD', 'DISPID_SPEActualConfidence',
    'DISPID_SpeechCustomStream', 'SAFT22kHz16BitStereo',
    'SpeechDataKeyLocation', 'DISPID_SOTGetStorageFileName',
    'DISPID_SPRuleConfidence', 'SREAllEvents', 'DISPID_SLPLangId',
    'DISPID_SAVolume', 'SREFalseRecognition', 'SLTUser',
    'DISPID_SRCEPhraseStart', 'SPCONTEXTSTATE', 'SpeechRunState',
    'SpeechRetainedAudioOptions', 'DISPID_SVPriority',
    'DISPID_SGRsDynamic', 'DISPID_SPIElements',
    'DISPID_SRCEPropertyStringChange', 'SpeechWordType',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SOTCSetId',
    'DISPID_SpeechPhraseRules', 'DISPID_SpeechPhraseReplacement',
    'SPWT_PRONUNCIATION', 'SpeechSpecialTransitionType',
    'SDTProperty', 'DISPID_SRGetPropertyString', 'SPDKL_CurrentUser',
    'DISPID_SRRAlternates', 'SAFTCCITT_ALaw_22kHzMono', 'SPBO_AHEAD',
    'SPSMF_UPS', 'SAFT8kHz8BitMono', 'SPEI_RESERVED3',
    'DISPID_SGRsAdd', 'SPPHRASE', 'SAFT48kHz8BitStereo',
    'DISPID_SVESentenceBoundary', 'SPCATEGORYTYPE',
    'DISPID_SOTs_NewEnum', 'DISPID_SVEVoiceChange', 'SpStream',
    'SPPS_LMA', 'SpeechCategoryRecoProfiles', 'SPVPRIORITY',
    'DISPID_SpeechGrammarRule', 'SpeechAudioFormatGUIDWave',
    'SpeechMicTraining', 'ISpPhoneticAlphabetSelection',
    'DISPID_SPRNumberOfElements', 'SREAdaptation', 'SPXRO_SML',
    'DISPID_SPACommit', 'SpeechPropertyAdaptationOn', 'SP_VISEME_6',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SWFEExtraData',
    'DISPID_SWFEChannels', 'eWORDTYPE_DELETED',
    'SpeechRecoContextState', 'SPINTERFERENCE_TOOSLOW', 'SPWORDLIST',
    'DISPID_SVEViseme', 'SPLO_STATIC', 'SPWF_INPUT', 'SP_VISEME_2',
    'SP_VISEME_19', 'SPEI_SOUND_END', 'SAFTExtendedAudioFormat',
    'SSFMCreateForWrite', 'SGSDisabled', 'SVP_19',
    'DISPID_SOTDataKey', 'ISpResourceManager',
    'DISPID_SPPFirstElement', 'SAFT24kHz8BitStereo',
    'DISPID_SLPsCount', 'DISPID_SAFType', 'SPRULESTATE', 'SVP_5',
    'ISpPhraseAlt', 'SASClosed', 'DISPID_SPELexicalForm',
    'SpeechStreamSeekPositionType', 'SpPhoneConverter',
    'SAFTADPCM_8kHzMono', 'DISPID_SGRAddResource',
    'DISPID_SRCEBookmark', 'SpCompressedLexicon', 'SPEI_UNDEFINED',
    'DISPID_SASCurrentDevicePosition', 'SpeechTokenIdUserLexicon',
    'DISPID_SPRuleNumberOfElements', 'SLOStatic', 'SGPronounciation',
    'DISPIDSPTSI_ActiveOffset', 'ISpeechRecognizer',
    'DISPID_SVSInputWordPosition', 'ISpeechPhraseElement',
    'ISpPhoneticAlphabetConverter',
    'SpeechPropertyNormalConfidenceThreshold', 'SPLOADOPTIONS',
    'SDTAll', 'DISPID_SBSFormat', 'DISPID_SRCEAudioLevel',
    'ISpeechRecoContext', 'SpeechTokenKeyUI',
    'Speech_StreamPos_RealTime', 'DISPID_SRIsShared', 'SP_VISEME_15',
    'DISPID_SPISaveToMemory', 'DISPID_SRCCreateResultFromMemory',
    'SAFTCCITT_uLaw_8kHzStereo', 'SVPNormal', 'SITooFast',
    'ISpeechVoice', 'SAFTCCITT_uLaw_8kHzMono', 'SPRULE',
    'SAFTGSM610_22kHzMono', 'SPPS_SuppressWord',
    'SAFTGSM610_44kHzMono', 'DISPID_SRRTOffsetFromStart',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SPRulesItem',
    'DISPID_SPIAudioSizeBytes', 'ISpStreamFormatConverter',
    'DISPID_SPIRetainedSizeBytes', 'SPFM_NUM_MODES',
    'IInternetSecurityMgrSite', 'SVEPrivate',
    'DISPID_SLPPartOfSpeech', 'SGRSTTTextBuffer',
    'ISpeechMemoryStream', 'SAFT22kHz8BitStereo',
    'DISPID_SAFGetWaveFormatEx', 'ISpRecoGrammar',
    'ISpeechCustomStream', 'ISpeechPhraseProperties',
    'DISPID_SVSLastResult', 'SPBO_TIME_UNITS',
    'DISPID_SRGDictationLoad', 'DISPID_SVSPhonemeId',
    'DISPID_SRRGetXMLErrorInfo', 'SP_VISEME_18',
    'DISPID_SDKCreateKey', 'SREPrivate', 'SECFNoSpecialChars',
    'DISPID_SRCRecognizer', 'DISPID_SpeechBaseStream',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SDTLexicalForm', 'DISPID_SPIGrammarId',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SVSInputSentencePosition',
    'SPEI_PHONEME', 'DISPID_SPRFirstElement',
    'SpeechRegistryUserRoot', 'SRTReSent', 'eLEXTYPE_PRIVATE18',
    'DISPID_SRRecognizer', 'SGRSTTRule', 'SPGRAMMARSTATE',
    'eLEXTYPE_PRIVATE16', 'SPPARTOFSPEECH', 'SPEVENTENUM',
    'SpeechVoiceCategoryTTSRate', 'SPGRAMMARWORDTYPE', 'SPBO_NONE',
    'SVEAudioLevel', 'SP_VISEME_5', 'DISPID_SWFEBitsPerSample',
    'DISPID_SOTCreateInstance', 'SpeechGrammarWordType',
    'SPGS_ENABLED', 'SRARoot', 'SPPS_NotOverriden', 'DISPID_SOTsItem',
    'SVP_1', 'SVP_8', 'ISpRecoContext',
    'DISPID_SpeechGrammarRuleStateTransition', 'SpAudioFormat',
    'DISPID_SpeechPhraseElement', 'DISPID_SVIsUISupported',
    'ISpStreamFormat', 'DISPID_SRAudioInput',
    'SAFTCCITT_ALaw_11kHzMono', 'SECFIgnoreWidth',
    'eLEXTYPE_PRIVATE9', 'ISpeechLexiconWords',
    'DISPID_SpeechLexiconWord', 'eLEXTYPE_VENDORLEXICON',
    'SRTStandard', 'ISpLexicon', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SWFEFormatTag',
    'DISPID_SpeechMemoryStream', 'SVP_17',
    'DISPID_SOTCEnumerateTokens', 'SAFTCCITT_uLaw_22kHzMono',
    'SPEI_MIN_TTS', 'SGDSActiveWithAutoPause', 'SPAO_NONE',
    'SRSActive', 'ISpeechRecoResultTimes', 'DISPID_SpeechRecoContext',
    'SP_VISEME_8', 'DISPID_SRCSetAdaptationData', 'DISPID_SVPause',
    'SPEI_ADAPTATION', 'DISPID_SDKGetStringValue', 'SPGS_EXCLUSIVE',
    'SVSFVoiceMask', 'SVSFParseMask', 'ISpeechPhraseInfoBuilder',
    'DISPIDSPRG', 'SpeechGrammarTagWildcard', 'SPEI_REQUEST_UI',
    'Speech_Max_Pron_Length', 'ISpGrammarBuilder', 'SPGS_DISABLED',
    'DISPID_SLAddPronunciation', 'SECNormalConfidence',
    'SAFT48kHz8BitMono', 'DISPID_SGRClear',
    'DISPID_SLAddPronunciationByPhoneIds', 'SAFT11kHz8BitMono',
    'SRCS_Disabled', 'SPEI_END_SR_STREAM', 'DISPID_SpeechVoiceEvent',
    'DISPID_SPIEngineId', 'SRERequestUI', 'SPPS_RESERVED2',
    'SAFT44kHz8BitStereo', 'SINoSignal', 'ISpVoice',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SpeechPhraseInfo',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SOTCGetDataKey', 'SREHypothesis', 'SPAR_Low',
    'DISPID_SpeechVoice', 'DISPID_SRGDictationUnload',
    'DISPID_SRCESoundEnd', 'STSF_CommonAppData', 'ISpRecognizer3',
    'DISPID_SLWType', 'ISpAudio', 'SGRSTTDictation',
    'eLEXTYPE_PRIVATE1', 'SpeechRuleState', 'SECFIgnoreCase',
    'SPCT_SUB_DICTATION', 'DISPID_SVStatus', 'DISPID_SPCIdToPhone',
    'DISPID_SLWWord', 'eLEXTYPE_PRIVATE14', 'SPAS_PAUSE',
    'SAFT24kHz16BitStereo', 'ISpMMSysAudio',
    'SpPhoneticAlphabetConverter', 'DISPID_SPAsItem',
    'SpeechVoiceSpeakFlags', 'DISPIDSPTSI_SelectionLength',
    'SBOPause', 'DISPID_SGRsFindRule', 'SVP_9', 'SVF_None',
    'SPSHORTCUTTYPE', 'DISPID_SWFEAvgBytesPerSec', 'SRESoundEnd',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRGCmdLoadFromObject',
    'SRERecognition', 'DISPID_SASNonBlockingIO',
    'DISPID_SVSInputSentenceLength', 'eLEXTYPE_PRIVATE20',
    'SAFT32kHz16BitMono', 'DISPID_SRCERequestUI',
    'ISpeechPhraseAlternates', 'SPADAPTATIONRELEVANCE',
    'DISPID_SPIStartTime', 'DISPID_SPRsCount', 'SPWORDPRONOUNCEABLE',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SGRSTPropertyId',
    'SpShortcut', 'SRCS_Enabled', 'SpeechAudioProperties',
    'ISpeechPhraseRule', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRCVoicePurgeEvent', 'SPAS_STOP',
    'ISpeechPhraseReplacements', 'SPPS_RESERVED4',
    'DISPID_SPILanguageId', 'ISpeechGrammarRule',
    'SWPUnknownWordUnpronounceable', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SGDSInactive', 'DISPID_SGRSTText', 'ISpRecognizer',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SDTAlternates',
    'DISPID_SRCERecognitionForOtherContext', 'ISpeechPhraseInfo',
    'SP_VISEME_20', 'DISPID_SpeechObjectTokens', 'SpWaveFormatEx',
    'DISPID_SLWsCount', 'DISPID_SPEDisplayText', 'SPEI_RESERVED5',
    'SVSFNLPMask', 'SP_VISEME_3', 'SAFTNoAssignedFormat', 'SPAR_High',
    'DISPID_SGRsCommit', 'SPXMLRESULTOPTIONS', '_SPAUDIOSTATE',
    'SPRST_ACTIVE', 'DISPID_SRRTimes', 'DISPID_SABIEventBias',
    'SpeechVoiceSkipTypeSentence', 'SpSharedRecognizer',
    'DISPID_SGRsCommitAndSave', 'SAFT44kHz8BitMono', 'SREStreamStart',
    'DISPID_SDKSetLongValue', 'DISPID_SRSetPropertyString',
    'SPVOICESTATUS', 'DISPID_SRRAudioFormat', 'DISPID_SRCESoundStart',
    'DISPID_SRRGetXMLResult', 'SAFTGSM610_8kHzMono', 'SRADynamic',
    'SRAExport', 'SPTEXTSELECTIONINFO', 'UINT_PTR',
    'DISPID_SRRPhraseInfo', 'SSSPTRelativeToStart',
    'SRSInactiveWithPurge', 'SpeechRuleAttributes', 'SP_VISEME_1',
    'DISPID_SpeechPhraseReplacements', 'SPSSuppressWord',
    'ISpeechLexiconPronunciations', 'SAFTCCITT_uLaw_44kHzMono',
    'SPEVENTSOURCEINFO', 'SREStateChange', 'SSFMOpenReadWrite',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SOTGetAttribute',
    'DISPID_SRRRecoContext', 'DISPID_SOTCategory', 'LONG_PTR',
    'DISPID_SLGenerationId', 'SAFT11kHz16BitMono',
    'DISPID_SGRInitialState', 'DISPID_SDKEnumKeys', 'SVP_6',
    'DISPID_SRGIsPronounceable',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SVSLastBookmarkId', 'SPEI_SOUND_START',
    'SPEI_END_INPUT_STREAM', 'eLEXTYPE_RESERVED7',
    'DISPID_SVSLastStreamNumberQueued', 'SPFILEMODE', 'SVP_2',
    'DISPID_SRDisplayUI', 'WAVEFORMATEX', 'eLEXTYPE_RESERVED9',
    'SpeechPropertyResponseSpeed', 'SP_VISEME_17',
    'DISPID_SABIMinNotification', 'DISPID_SVAudioOutputStream',
    'SpStreamFormatConverter', 'DISPID_SGRAttributes', 'SLODynamic',
    'ISpeechPhraseRules', 'DISPID_SOTCId', 'SECHighConfidence',
    'SAFT44kHz16BitMono', 'DISPID_SpeechAudioBufferInfo',
    'ISpPhoneConverter', 'DISPID_SRGCmdSetRuleIdState', 'SPSVerb',
    'SVEViseme', 'DISPID_SPEEngineConfidence', 'DISPID_SASState',
    'DISPID_SRCEInterference', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SGRSTsItem', 'SPSEMANTICERRORINFO',
    'DISPID_SpeechPhraseProperties', 'SRERecoOtherContext',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpRecoContext2',
    'SAFT22kHz8BitMono', 'SPINTERFERENCE_TOOFAST',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechCategoryPhoneConverters',
    'DISPID_SpeechMMSysAudio', 'eLEXTYPE_PRIVATE4',
    'SPPS_Interjection', 'SpeechAllElements', 'DISPID_SPIProperties',
    '_RemotableHandle', 'DISPID_SLPs_NewEnum',
    'tagSPTEXTSELECTIONINFO', 'SAFTCCITT_ALaw_11kHzStereo',
    'SAFTGSM610_11kHzMono', 'SpeechTokenShellFolder',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SMSADeviceId',
    'DISPID_SDKDeleteKey', 'tagSPPROPERTYINFO', 'SpResourceManager',
    'DISPIDSPTSI', 'SPEI_RESERVED1', 'SpNotifyTranslator',
    'DISPID_SPRules_NewEnum', 'SBONone', 'Speech_Default_Weight',
    'SpeechPropertyLowConfidenceThreshold', 'SPRS_ACTIVE',
    'SPEI_VOICE_CHANGE', 'SPSEMANTICFORMAT', 'DISPID_SVEPhoneme',
    'DISPID_SPPChildren', 'DISPID_SRCEAdaptation', 'DISPID_SGRId',
    'SPCT_COMMAND', 'ISpeechLexiconWord', 'SDTDisplayText',
    'SPVISEMES', 'ISpeechWaveFormatEx', 'DISPID_SGRs_NewEnum',
    'SAFT8kHz8BitStereo', 'SpInprocRecognizer',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SpObjectToken',
    'SpeechRecognizerState', 'SGLexical', 'SASPause',
    'ISpeechRecognizerStatus', 'SRSActiveAlways', 'ISpEventSink',
    'DISPID_SGRSTransitions', 'DISPID_SPPValue',
    'DISPID_SPRs_NewEnum', 'SpeechCategoryAudioOut',
    'DISPID_SRGReset', 'SPEI_TTS_PRIVATE',
    'DISPID_SRCRetainedAudioFormat', 'SPEI_MIN_SR',
    'DISPID_SRGetRecognizers', 'SpeechAudioState', 'SPPS_Noun',
    'DISPID_SVEventInterests', 'DISPID_SGRSTWeight',
    'SDA_Two_Trailing_Spaces', 'SPEI_RESERVED2',
    'DISPID_SPPs_NewEnum', 'SAFT32kHz8BitStereo',
    'SPINTERFERENCE_TOOQUIET', 'eLEXTYPE_PRIVATE17',
    'SSSPTRelativeToCurrentPosition', 'SECFDefault',
    'DISPID_SLGetPronunciations', 'SRTExtendableParse',
    'SpMMAudioOut', 'ISpeechMMSysAudio', 'SPRST_NUM_STATES',
    'DISPID_SpeechRecognizerStatus', 'SAFT24kHz16BitMono',
    'DISPID_SRCBookmark', 'SpeechCategoryVoices', 'SPEI_SR_BOOKMARK',
    'eLEXTYPE_PRIVATE15', 'SpeechStreamFileMode',
    'SPEI_RECO_OTHER_CONTEXT', 'SpeechEmulationCompareFlags',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRGId', 'SWTAdded',
    'DISPID_SVGetProfiles', 'SPRST_ACTIVE_ALWAYS',
    'SREPropertyStringChange', 'DISPID_SVSRunningState',
    'SPVPRI_NORMAL', 'DISPID_SPEAudioSizeTime', 'SPRECORESULTTIMES',
    'SpCustomStream', 'SVSFParseSsml', 'SGDSActive',
    'DISPID_SGRSTRule', 'SpObjectTokenCategory', 'SVP_21',
    'SPBO_PAUSE', 'SAFT12kHz8BitMono', 'SPSERIALIZEDRESULT',
    'eLEXTYPE_PRIVATE11', 'SPEI_HYPOTHESIS', 'DISPID_SRCVoice',
    'SpNullPhoneConverter', 'SVSFPurgeBeforeSpeak',
    'SpeechPartOfSpeech', 'DISPID_SVGetVoices',
    'SREPropertyNumChange', 'eLEXTYPE_MORPHOLOGY', 'SSTTWildcard',
    'DISPID_SVSInputWordLength', 'SPWORDPRONUNCIATION',
    'SAFT11kHz16BitStereo', 'DISPID_SVSpeak', 'SDTPronunciation',
    'ISpRecognizer2', 'SpeechDisplayAttributes',
    'DISPID_SVWaitUntilDone', 'DISPID_SRGSetTextSelection',
    'eLEXTYPE_RESERVED4', 'eWORDTYPE_ADDED',
    'DISPID_SpeechGrammarRules', 'DISPID_SPEAudioSizeBytes',
    'SPINTERFERENCE_TOOLOUD', 'SGSExclusive', 'SPBINARYGRAMMAR',
    'SVP_7', 'DISPID_SAFSetWaveFormatEx', 'DISPID_SPAsCount',
    'DISPID_SpeechFileStream', 'SAFTDefault', 'SAFTADPCM_22kHzMono',
    'SPPHRASERULE', 'DISPID_SREmulateRecognition',
    'DISPID_SRSCurrentStreamNumber', 'SAFT12kHz8BitStereo',
    'SPDKL_LocalMachine', 'DISPID_SOTSetId',
    'ISpeechGrammarRuleStateTransition', 'SAFTADPCM_11kHzMono',
    'SRAORetainAudio', 'DISPID_SPRuleId', 'ISequentialStream',
    'DISPID_SRCResume', 'DISPID_SpeechPhraseAlternates',
    'SPSHT_EMAIL', 'DISPID_SVEStreamStart', 'SREAudioLevel',
    'SpeechTokenContext', 'ISpProperties',
    'DISPID_SpeechPhraseProperty', 'SpTextSelectionInformation',
    'STCInprocHandler', 'ISpeechPhoneConverter', 'SVEVoiceChange',
    'DISPID_SADefaultFormat', 'DISPID_SRGetFormat',
    'DISPID_SVSpeakStream', 'DISPID_SLPPhoneIds',
    'ISpeechObjectTokens', 'DISPID_SpeechPhraseElements',
    'SPLEXICONTYPE', 'ISpeechAudioStatus', 'SPSUnknown',
    'DISPID_SRCEEndStream', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRSClsidEngine', 'DISPID_SRRSetTextFeedback',
    'DISPID_SPIEnginePrivateData', 'DISPID_SOTCDefault',
    'ISpeechLexicon', 'SpeechAudioFormatGUIDText',
    'DISPID_SGRSAddWordTransition', 'IEnumString', 'DISPID_SVResume',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SOTGetDescription', 'DISPID_SPEPronunciation',
    'SpeechFormatType', 'DISPID_SpeechObjectToken',
    'DISPID_SpeechDataKey', 'SPEI_MAX_TTS', 'DISPID_SBSRead',
    'SpFileStream', 'SPPS_RESERVED3', 'DISPID_SGRSRule',
    'SpUnCompressedLexicon', 'SPEI_RECO_STATE_CHANGE',
    'SAFTCCITT_uLaw_11kHzStereo', 'SP_VISEME_0', 'SP_VISEME_4',
    'SAFT12kHz16BitStereo', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPPEngineConfidence',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SBSSeek',
    'SVEEndInputStream', 'DISPID_SABufferNotifySize',
    'DISPID_SPEs_NewEnum', 'DISPID_SRState', 'SPEI_PHRASE_START',
    'ISpeechObjectTokenCategory', 'DISPIDSPTSI_SelectionOffset',
    'SVP_16', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechCategoryAppLexicons', 'DISPID_SAEventHandle',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRSCurrentStreamPosition', 'SPWAVEFORMATTYPE',
    'SDKLCurrentConfig', 'DISPID_SPRulesCount', 'ISpNotifyTranslator',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPRsItem', 'SINone',
    'SPWORDTYPE', 'DISPID_SVEStreamEnd', 'SP_VISEME_14',
    'SpeechGrammarState', 'DISPID_SVEWord', 'SPFM_CREATE_ALWAYS',
    'DISPID_SGRName', 'SITooLoud', 'DISPID_SPRuleEngineConfidence',
    'SPEI_WORD_BOUNDARY', 'ISpeechVoiceStatus', 'ISpNotifySink',
    'DISPID_SRGCmdLoadFromResource', 'ISpDataKey',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SVAudioOutput',
    'DISPID_SLPSymbolic', 'SPSHT_Unknown', 'SECLowConfidence',
    'eLEXTYPE_PRIVATE5', 'DISPID_SPRuleName', 'SVSFlagsAsync',
    'DISPID_SDKOpenKey', 'SPEI_START_INPUT_STREAM',
    'SPXRO_Alternates_SML', 'DISPID_SPRuleFirstElement',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SRSetPropertyNumber',
    'SGSEnabled', 'SpPhraseInfoBuilder', 'SRSEIsSpeaking',
    'DISPID_SpeechWaveFormatEx', 'SAFTNonStandardFormat',
    'SPAUDIOSTATE', 'SPAR_Unknown', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SPRText', 'SPAUDIOBUFFERINFO', 'SpeechTokenKeyAttributes',
    'DISPID_SPAStartElementInResult', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SPEsCount', 'IStream', 'SVEBookmark',
    'DISPID_SASCurrentSeekPosition', 'STCLocalServer',
    'eLEXTYPE_PRIVATE3', 'DISPID_SVVoice', 'eLEXTYPE_USER_SHORTCUT',
    'eLEXTYPE_USER', 'SpVoice', 'DISPID_SRSAudioStatus', 'SPSNoun',
    'DISPID_SFSClose', 'DISPID_SRCCreateGrammar', 'SRSEDone',
    'DISPID_SRCEHypothesis', 'SPEI_MAX_SR', 'SGLexicalNoSpecialChars',
    'SAFT16kHz8BitStereo', 'SP_VISEME_10', 'DISPID_SWFEBlockAlign',
    'DISPID_SVSpeakCompleteEvent', 'SPAS_RUN',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SLGetGenerationChange',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SOTsCount', 'SRSInactive',
    'SECFEmulateResult', 'DISPID_SpeechPhraseRule',
    'DISPID_SRAudioInputStream', 'SPAUDIOOPTIONS', 'SAFTText',
    'DISPID_SVSyncronousSpeakTimeout', 'SPEI_INTERFERENCE',
    'DISPID_SVGetAudioInputs', 'SSFMCreate', 'SPEI_VISEME',
    'tagSTATSTG', 'SpeechRecoProfileProperties',
    'ISpeechPhraseAlternate', 'DISPID_SPCLangId', 'SDTAudio',
    'DISPID_SCSBaseStream', 'DISPID_SPPNumberOfElements',
    'ISpeechGrammarRules', 'SPSNotOverriden', 'DISPID_SRRTStreamTime',
    'DISPID_SGRsItem', 'SVP_0', 'SPEI_SR_AUDIO_LEVEL', 'SWTDeleted',
    'SPPS_Verb', 'SpeechDictationTopicSpelling',
    'DISPID_SDKGetBinaryValue', 'DISPID_SPIReplacements',
    'DISPID_SVSkip', 'SPPROPERTYINFO', 'SPSInterjection',
    'ISpXMLRecoResult', 'DISPID_SRCEventInterests', 'SPCS_DISABLED',
    'ISpeechLexiconPronunciation', 'SPRST_INACTIVE',
    'DISPID_SPARecoResult', 'eLEXTYPE_PRIVATE6', 'DISPID_SAStatus',
    'SRAONone', 'SPPS_Function', 'SWPUnknownWordPronounceable',
    'ISpeechRecoGrammar', 'DISPID_SOTId',
    'DISPID_SRGCmdLoadFromMemory', 'SVSFNLPSpeakPunc',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRRAudio',
    'SVEWordBoundary', 'DISPID_SDKEnumValues',
    'DISPID_SGRSAddRuleTransition', 'ISpObjectToken',
    'SVSFPersistXML', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'eLEXTYPE_APP',
    'SPPS_Noncontent', 'SVP_20', 'DISPID_SOTMatchesAttributes',
    'SpMMAudioEnum', 'SRTAutopause', 'SPSMF_SAPI_PROPERTIES',
    'SPDATAKEYLOCATION', 'DISPID_SDKDeleteValue',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SVPAlert',
    '__MIDL_IWinTypes_0009', 'DISPID_SVSLastBookmark',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SAFT22kHz16BitMono',
    'SPAUDIOSTATUS', 'SASRun', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SOTRemove', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SWFESamplesPerSec', 'SpeechRecognitionType',
    'SpeechEngineConfidence', 'SpeechVoicePriority',
    'SAFT32kHz8BitMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SABufferInfo', 'DISPID_SPRuleParent', 'SINoise',
    'DISPID_SGRSTs_NewEnum', 'ISpObjectTokenCategory',
    'DISPID_SPAPhraseInfo', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SGRAddState', 'DISPID_SpeechLexiconProns', 'SREStreamEnd',
    'DISPID_SPAs_NewEnum',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SLWsItem',
    'SGRSTTWildcard', 'DISPID_SMSALineId', 'ISpRecoGrammar2',
    'ISpStream', 'DISPID_SRCERecognizerStateChange',
    'IEnumSpObjectTokens', 'SPRS_INACTIVE',
    'DISPID_SPRDisplayAttributes', 'ISpObjectWithToken',
    'DISPID_SpeechLexiconWords', 'DISPID_SLWLangId', 'SPAS_CLOSED',
    'SP_VISEME_7', 'SRADefaultToActive', 'ISpRecoCategory',
    'DISPID_SRCState', 'SpeechPropertyComplexResponseSpeed',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpeechGrammarTagDictation',
    'DISPID_SGRSTPropertyName', 'DISPID_SVEBookmark',
    'ISpEventSource', 'SVSFIsXML', 'DISPID_SRStatus',
    '_ISpeechRecoContextEvents', 'SAFTADPCM_8kHzStereo',
    'SPVPRI_OVER', 'DISPID_SBSWrite', 'DISPID_SVVolume',
    'ISpeechResourceLoader', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'Speech_Max_Word_Length', 'ISpeechPhraseProperty',
    'DISPID_SpeechPhoneConverter', 'SVSFParseSapi', 'SPEI_RESERVED6',
    'SpeechAudioVolume', 'DISPID_SLPType', 'eLEXTYPE_PRIVATE7',
    'DISPID_SpeechRecognizer', 'SPINTERFERENCE_NOISE',
    'DISPID_SPIRule', 'SVESentenceBoundary', 'DISPID_SLGetWords',
    'DISPID_SpeechLexicon', 'SPPHRASEPROPERTY', 'SFTInput',
    'SPINTERFERENCE', 'DISPID_SRCRetainedAudio',
    'ISpeechXMLRecoResult', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'ISpeechAudioFormat', 'SAFTCCITT_ALaw_22kHzStereo',
    'SAFT48kHz16BitMono', 'STCRemoteServer', 'SGRSTTWord',
    'DISPID_SGRSTNextState', 'DISPID_SRGRecoContext',
    'SREPhraseStart', 'SPEI_START_SR_STREAM', 'DISPID_SRRTTickCount',
    'SREInterference', 'SAFT48kHz16BitStereo', 'SAFT16kHz8BitMono',
    'eLEXTYPE_RESERVED10', 'SDA_Consume_Leading_Spaces',
    'SPPHRASEREPLACEMENT', 'ISpPhrase', 'SDTRule',
    'DISPID_SRRSaveToMemory', 'SVP_18', 'SDKLLocalMachine',
    'SpeechLexiconType', 'SPSLMA', 'DISPID_SRSNumberOfActiveRules',
    'ISpRecoResult', 'SPSHORTCUTPAIRLIST',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SRAInterpreter',
    'SpeechVisemeFeature', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'eLEXTYPE_RESERVED6', 'DISPID_SPIGetText',
    'DISPID_SVGetAudioOutputs', 'SAFT8kHz16BitStereo',
    'DISPID_SPERequiredConfidence', 'SPEI_TTS_BOOKMARK',
    'SPBOOKMARKOPTIONS', 'DISPID_SMSSetData', 'SVSFIsFilename',
    'SPINTERFERENCE_NONE', 'SpeechAudioFormatType',
    'SpeechWordPronounceable', 'DISPID_SMSAMMHandle',
    'SpeechDiscardType', 'SSSPTRelativeToEnd',
    'DISPID_SRCRequestedUIType', 'SpLexicon',
    'ISpeechPhraseReplacement', 'DISPID_SOTIsUISupported',
    'SPPS_Modifier', 'SDA_No_Trailing_Space',
    'ISpeechTextSelectionInformation', 'ISpeechBaseStream', 'SVP_4',
    'SVSFIsNotXML', 'DISPID_SRCEStartStream', 'ISpeechFileStream',
    'SPCT_DICTATION', 'IInternetSecurityManager',
    'ISpeechObjectToken', 'SP_VISEME_9', 'SP_VISEME_12',
    'ISpShortcut', 'DISPID_SpeechRecoResult2',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPDKL_DefaultLocation',
    'DISPID_SPEDisplayAttributes', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SDKGetlongValue', 'SpeechAddRemoveWord', 'SVP_13',
    'SPFM_CREATE', 'SPAO_RETAIN_AUDIO', 'SVP_3',
    'DISPID_SpeechRecoResult', 'DISPID_SPEsItem',
    'SpeechCategoryRecognizers', 'DISPID_SMSGetData', 'SP_VISEME_21',
    'SLTApp', 'SAFTADPCM_44kHzMono', 'DISPID_SPPsItem', 'SVP_15',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SRRSpeakAudio',
    'SITooQuiet', 'eLEXTYPE_PRIVATE12', 'DISPID_SGRsCount',
    'SVSFUnusedFlags', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRGRules', 'SPSHT_OTHER', 'ISpeechRecoResult',
    'SITooSlow', 'DISPID_SOTDisplayUI', 'SVSFDefault',
    'ISpeechDataKey', 'DISPID_SPRuleChildren',
    'DISPID_SDKSetStringValue', 'SPWT_LEXICAL', 'SPRECOGNIZERSTATUS',
    'DISPID_SRProfile', 'SAFT12kHz16BitMono', 'SpeechVoiceEvents',
    'DISPID_SDKSetBinaryValue', 'DISPID_SGRSAddSpecialTransition',
    'SRTSMLTimeout', 'DISPID_SpeechVoiceStatus',
    'SpeechEngineProperties', 'DISPID_SRGDictationSetState',
    'SAFT32kHz16BitStereo'
]

_check_version('1.1.14', 1610708496.308072)
